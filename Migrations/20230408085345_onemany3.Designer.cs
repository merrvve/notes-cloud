...
namespace nc2.Migrations
{
    ...
    [Migration("20230408085345_onemany3")]
    partial class onemany3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nc2.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdDate = new DateTime(2023, 4, 8, 11, 53, 45, 25, DateTimeKind.Local).AddTicks(482),
                            displayName = "merve",
                            email = "merve@merve.com",
                            modifiedDate = new DateTime(2023, 4, 8, 11, 53, 45, 25, DateTimeKind.Local).AddTicks(494),
                            uid = ""
                        });
                });
            ...
            modelBuilder.Entity("nc2.Models.NotebookUser", b =>
                {
                    b.HasOne("nc2.Models.Notebook", null)
                        .WithMany()
                        .HasForeignKey("notebooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("nc2.Models.User", null)
                        .WithMany()
