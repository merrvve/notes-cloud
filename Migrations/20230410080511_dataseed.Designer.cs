...
namespace nc2.Migrations
{
    ...
    [Migration("20230410080511_dataseed")]
            ...
            modelBuilder.Entity("nc2.Models.Note", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(1007),
                            modifiedDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(1009),
                            notebookId = 1,
                            textNote = "Sample"
                        });
                });
            ...
            modelBuilder.Entity("nc2.Models.Notebook", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(1030),
                            modifiedDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(1031),
                            name = "Sample"
                        });
                });
            ...
            modelBuilder.Entity("nc2.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(766),
                            displayName = "merve",
                            email = "merve@merve.com",
                            modifiedDate = new DateTime(2023, 4, 10, 11, 5, 11, 662, DateTimeKind.Local).AddTicks(781),
                            uid = ""
                        });
                });
